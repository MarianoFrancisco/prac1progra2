 ...
 * @author Mariano
 */
public class ProcesoEnsambles extends HttpServlet {
                    ...
                    while(rs1.next()){    
                        ...
                        while(rs.next()){
                            ...
                            if(Integer.parseInt(datosPieza[1])>=Integer.parseInt(datosMueble[2])){
                                ...
                                st.executeUpdate();          
                                response.sendRedirect("fabrica.jsp?usuarioInicial="+usuarioInicial);
                            }else{
                                JOptionPane.showMessageDialog(null, "No tienes suficientes piezas");
                                response.sendRedirect("fabrica.jsp?usuarioInicial="+usuarioInicial);
                            }
                        }
                        }
